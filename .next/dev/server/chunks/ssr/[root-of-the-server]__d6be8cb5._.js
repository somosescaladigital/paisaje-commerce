...
/* __next_internal_action_entry_do_not_use__ [{"00840a272047a5e8bb899c2d29317caae3090bc43d":"adminLogout","40fdf0168a0051e3e0439b9f9830ecb1ef43643a2f":"adminLogin"},"",""] */ __turbopack_context__.s([
    "adminLogin",
    ()=>adminLogin,
    "adminLogout",
    ()=>adminLogout
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(adminLogin, "40fdf0168a0051e3e0439b9f9830ecb1ef43643a2f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(adminLogout, "00840a272047a5e8bb899c2d29317caae3090bc43d", null);
}),
"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"400987150f212ccd10a6b3d0b46d36e2f385924dac":"createProduct","400fed90c362c1ea0bec4bc8be7f55696d8fac4828":"updateProduct","40809aea7b08c42c1c3536099b6c32e56268c340c1":"deleteCourseMedia","40a1dbb287365d278a9a0f8dbfe1683913c0d3fb40":"deleteResourceFile","40fbfa2a0b0ab2a8f94bcfd182873bf2c64da1acd9":"deleteProduct"},"",""] */ __turbopack_context__.s([
    "createProduct",
    ()=>createProduct,
    "deleteCourseMedia",
    ()=>deleteCourseMedia,
...
async function createProduct(formData) {
    ...
    const type = formData.get('type') || 'digital';
    const es_membresia = formData.get('es_membresia') === 'true';
    const duracion_meses = parseInt(formData.get('duracion_meses') || '1');
    const imageFile = formData.get('imagen');
    const resourceFiles = formData.getAll('archivo');
    // Validaciones básicas
    if (!nombre || !descripcion) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/commerce/admin/nuevo/${type}?error=validation`);
    }
    ...
    if (productError) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/commerce/admin/nuevo/${type}?error=database`);
    }
...
async function processCourseMultimedia(supabase, productId, formData) {
    console.log('DEBUG: Iniciando processCourseMultimedia para producto:', productId);
    let orden = 0;
    try {
        const galeryImages = formData.getAll('imagen_galeria');
        const videoUrls = formData.getAll('video_url');
        const videoFiles = formData.getAll('video_archivo');
        console.log(`DEBUG: Encontrado: ${galeryImages.length} imágenes galería, ${videoUrls.length} URLs video, ${videoFiles.length} archivos video`);
        for (const file of galeryImages){
            if (file && file.size && file.size > 0 && file.name !== 'undefined') {
                ...
                const { error: uploadError } = await supabase.storage.from('productos-digitales-portadas').upload(fileName, file);
                if (uploadError) {
                    console.error('ERROR subiendo imagen de galería:', uploadError.message, uploadError);
                } else {
                    const { data: { publicUrl } } = supabase.storage.from('productos-digitales-portadas').getPublicUrl(fileName);
                    const { error: insertError } = await supabase.from('curso_multimedia').insert({
                        producto_id: productId,
                        nombre: file.name,
                        url: publicUrl,
                        tipo: 'imagen',
                    ...
                    if (insertError) {
                        ...
                        console.log('OK: Imagen de galería guardada:', file.name);
                    }
                }
            }
        }
        ...
        for (const url of videoUrls){
            ...
            if (trimmedUrl.length > 0) {
                console.log('DEBUG: Insertando video URL:', trimmedUrl);
                try {
                    const { error: insertError } = await supabase.from('curso_multimedia').insert({
                        producto_id: productId,
                    ...
                    if (insertError) {
                        ...
                        console.log('OK: URL de video guardada:', trimmedUrl);
                    }
                } catch (err) {
            ...
            if (file && file.size && file.size > 0 && file.name !== 'undefined') {
                ...
                if (uploadError) {
                    ...
                    if (insertError) {
                        ...
                        console.log('OK: Archivo de video guardado:', file.name);
                    }
                }
            }
        }
...
async function deleteCourseMedia(mediaId) {
    const supabase = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2f$server$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["createClient"])();
    const { error } = await supabase.from('curso_multimedia').delete().eq('id', mediaId);
    if (error) {
...
async function updateProduct(formData) {
    ...
    const updateData = {
        ...
        duracion_meses: parseInt(formData.get('duracion_meses') || '1')
    };
    ...
    if (productError) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$navigation$2e$react$2d$server$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])(`/commerce/admin/editar/${id}?error=database`);
    }
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(createProduct, "400987150f212ccd10a6b3d0b46d36e2f385924dac", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteProduct, "40fbfa2a0b0ab2a8f94bcfd182873bf2c64da1acd9", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteResourceFile, "40a1dbb287365d278a9a0f8dbfe1683913c0d3fb40", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(deleteCourseMedia, "40809aea7b08c42c1c3536099b6c32e56268c340c1", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateProduct, "400fed90c362c1ea0bec4bc8be7f55696d8fac4828", null);
}),
"[project]/.next-internal/server/app/commerce/admin/nuevo/curso/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/commerce/admin/nuevo/curso/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "00840a272047a5e8bb899c2d29317caae3090bc43d",
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$commerce$2f$admin$2f$nuevo$2f$curso$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$app$2f$actions$2f$emails$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f$src$2f$app$2f$commerce$2f28$auth$292f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f$src$2f$app$2f$commerce$2f$admin$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE3__$3d3e$__$225b$project$5d2f$src$2f$app$2f$commerce$2f$admin$2f$nuevo$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/commerce/admin/nuevo/curso/page/actions.js { ACTIONS_MODULE0 => "[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)", ACTIONS_MODULE3 => "[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$actions$2f$emails$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$commerce$2f28$auth$292f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$commerce$2f$admin$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$commerce$2f$admin$2f$nuevo$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6be8cb5._.js.map