    ...
    try {
        ...
        for (const file of galeryImages){
            if (file && file.size && file.size > 0 && file.name !== 'undefined') {
                ...
                if (!uploadError) {
                    const { data: { publicUrl } } = supabase.storage.from('productos-digitales-portadas').getPublicUrl(fileName);
                    await supabase.from('curso_multimedia').insert({
                        producto_id: productId,
                        nombre: file.name,
                        url: publicUrl,
                        tipo: 'imagen',
        ...
        for (const [key, value] of formData.entries()){
            if (key === 'video_url' && typeof value === 'string' && value.trim().length > 0) {
        ...
        for (const url of videoUrls){
            if (url && url.trim()) {
                try {
                    await supabase.from('curso_multimedia').insert({
                        producto_id: productId,
                        nombre: extractVideoTitle(url),
                        url: url.trim(),
                        tipo: 'video',
                        orden: orden++
                    });
                } catch (err) {
                    console.error('Error inserting video URL:', err, url);
                }
            }
        }
...
"[project]/.next-internal/server/app/commerce/admin/editar/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/commerce/admin/editar/[id]/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/actions/emails.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE3 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "400fed90c362c1ea0bec4bc8be7f55696d8fac4828",
    ...
    "40809aea7b08c42c1c3536099b6c32e56268c340c1",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$commerce$2f$admin$2f$nuevo$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["deleteCourseMedia"],
    "40a1dbb287365d278a9a0f8dbfe1683913c0d3fb40",
    ...
    "40fbfa2a0b0ab2a8f94bcfd182873bf2c64da1acd9",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__dbb03d3c._.js.map