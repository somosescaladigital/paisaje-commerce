...
/* __next_internal_action_entry_do_not_use__ [{"40e9f252057d2dbb7592e789f5e10cd06706b875bf":"createProduct"},"",""] */ __turbopack_context__.s([
    "createProduct",
    ()=>createProduct
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-rsc] (ecmascript)");
...
async function createProduct(formData) {
    ...
    const pdfFile = formData.get('archivo');
    let imagen_url = '';
    let archivo_url = '';
    // 1. Subir Imagen
    if (imageFile && imageFile.size > 0) {
        ...
        const { data: uploadData, error: uploadError } = await supabase.storage.from('productos-portadas').upload(fileName, imageFile);
        if (uploadError) {
            console.error('Error subiendo imagen:', uploadError);
        } else {
            const { data: { publicUrl } } = supabase.storage.from('productos-portadas').getPublicUrl(fileName);
    ...
    if (pdfFile && pdfFile.size > 0) {
        ...
        const fileName = `${Math.random()}.${fileExt}`;
        const { data: uploadData, error: uploadError } = await supabase.storage.from('productos-archivos').upload(fileName, pdfFile);
        if (uploadError) {
            console.error('Error subiendo PDF:', uploadError);
        } else {
            const { data: { publicUrl } } = supabase.storage.from('productos-archivos').getPublicUrl(fileName);
    ...
    if (error) {
        ...
        // Redirigir con error si es necesario
        return;
    }
...
"[project]/.next-internal/server/app/commerce/admin/nuevo/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.next-internal/server/app/commerce/admin/nuevo/page/actions.js { ACTIONS_MODULE0 => \"[project]/src/app/commerce/(auth)/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/src/app/commerce/admin/actions.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/src/app/commerce/admin/nuevo/actions.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=_6bb3b03a._.js.map