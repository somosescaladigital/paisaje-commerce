...
function DynamicLayoutWrapper(t0) {
    ...
    if ($[0] !== "17db9d757355da476071665aa2b09dcddef4dd441224a1ec5972140f2ac34b0d") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "17db9d757355da476071665aa2b09dcddef4dd441224a1ec5972140f2ac34b0d";
    }
    ...
    const t2 = !hideLayoutElements && navbar;
    const t3 = `flex-1 relative flex flex-col ${hideLayoutElements ? "" : "pt-24 md:pt-28"}`;
    let t4;
    if ($[3] !== children || $[4] !== t3) {
...
//# sourceMappingURL=src_ae0e173c._.js.map