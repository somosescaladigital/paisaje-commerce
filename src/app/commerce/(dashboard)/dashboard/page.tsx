      ...
      <div className="px-4 sm:px-0">
        ...
        {!misCompras || misCompras.length === 0 ? (
          <div className="bg-white/50 rounded-[2rem] p-16 text-center border-2 border-light-green/20 border-dashed">
             ...
             <a href="/commerce/shop" className="bg-primary hover:bg-forest text-white px-10 py-4 rounded-full font-bold transition-all inline-block shadow-lg hover:shadow-forest/20">
               Explorar Catálogo
             </a>
          </div>
        ) : (
